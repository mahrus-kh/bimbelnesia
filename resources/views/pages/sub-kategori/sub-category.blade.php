...
@section('title')
    <title>Sub Kategori {{ request()->segment(2) }} | Bimbingan Belajar Indonesia - BimbelNesia</title>
@endsection
        ...
        <div class="row">
            <div class="col-md-3 mb-3">
                <div class="list-group">
                    <a href="{{ route('sub.kategori.index') }}" class="list-group-item list-group-item-action font-weight-bold">Semua Sub Kategori <span class="badge badge-light badge-pill font-weight-bold pull-right"></span></a>
